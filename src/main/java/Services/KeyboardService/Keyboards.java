...
public enum Keyboards {
    ...
    BANKS_KEYBOARD{
        ...
        public InlineKeyboardMarkup getKeyboard(Settings s ) {
            ...
            return InlineKeyboardMarkup.builder()
                    .keyboardRow(List.of(InlineKeyboardButton.builder()
                            .text(language.firstBankButton() + (s.getBanks().contains("privat") ? "✅" : ""))
                            .callbackData("privat")
                            .build()))
                    .keyboardRow(List.of(InlineKeyboardButton.builder()
                            .text(language.secondBankButton() + (s.getBanks().contains("mono") ? "✅" : ""))
                            .callbackData("mono")
                            .build()))
                    .keyboardRow(List.of(InlineKeyboardButton.builder()
                            .text(language.thirdBankButton() + (s.getBanks().contains("nbu") ? "✅" : ""))
                            .callbackData("nbu")
                            .build()))
                    .keyboardRow(List.of(InlineKeyboardButton.builder()
                            .text("Назад")
